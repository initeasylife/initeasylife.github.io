...
tags: ["单细胞", "Seurat", "R Markdown"]
description: "P453 数据的 Seurat 分析过程：预处理、降维、聚类与结果整理。"
kind: "实践记录"
math: false
download: "/assets/downloads/bioinformatics/453.Rmd"
permalink: "/bioinformatics/p453/"
---

本文保留原始分析代码，供阅读和复现参考。在线页面展示代码，不执行 R 分析。
