...
tags: ["SVM", "分类算法", "最优化"]
description: "从函数间隔、几何间隔到最优间隔分类器，梳理支持向量机的数学推导。"
permalink: "/jekyll/update/2018/06/27/svm.html"
---
...
通过求解对偶问题求解原问题，构造Lagrange公式(详见[Lagrange Duality]({{ "/jekyll/update/2018/06/29/Lagrange-Duality.html" | relative_url }}))：
