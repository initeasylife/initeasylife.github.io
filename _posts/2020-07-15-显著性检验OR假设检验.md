...
```
![pic](https://github.com/initeasylife/initeasylife.github.io/tree/master/pics/二项分布.png) 

```
假如我们扔了1000次，得到530次正面，那么这里的p值就是指：如果硬币均匀，扔1000次，正面的次数在530以上（即出现该结果或更极端的情况）的概率，如下图阴影部分所示
```
![pic](https://github.com/initeasylife/initeasylife.github.io/tree/master/pics/二项分布1.png)
